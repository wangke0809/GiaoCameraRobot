...
class TinyFace():
    ...
    def __init__(self, model_path, device='cuda'):
        ...
        log.info('[Tiny Face] loading with %s', self.device)
        ...
        self.net.eval()
        log.info('[Tiny Face] finished loading (%.4f sec)' % (time.time() - tstamp))
    ...
    def detect_faces(self, image, conf_th=0.8, scales=[1]):
        ...
        log.info('detect faces using %.6f sec' % (time.time() - tstamp))
